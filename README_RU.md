...
*   **Поворотные энкодеры** 2 x LPD3806 (VOL-L, VOL-R).
...
Проект печатной платы разработан в EasyEDA. Исходные файлы, Gerber-файлы для заказа и BOM (как будто бы он нужен вообще) находятся в `hardware/pcb/`.
